  ...
  return (
    <div className="page-container animate-fade-in">
      ...
      <div className="grid-4" style={{ marginBottom: '24px' }}>
        {[
          { label: 'Total Spent', value: `$${expenses.reduce((s,e)=>s+e.amount,0).toFixed(0)}`, color: 'var(--accent-red)' },
          { label: 'Monthly Budget', value: `$${budget.monthly}`, color: 'var(--accent-blue)' },
          { label: 'Largest Category', value: pieData[0]?.name || '-', color: 'var(--accent-orange)' },
          { label: 'Transactions', value: expenses.length, color: 'var(--accent-cyan)' },
        ].map((s, i) => (
