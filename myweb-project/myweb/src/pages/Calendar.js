...
import { Plus, ChevronLeft, ChevronRight, X, Check, Repeat, Clock, Tag, FileText } from 'lucide-react';
...
export default function CalendarPage() {
  ...
  const todayEvents = events.filter(e => isSameDay(new Date(e.date), selectedDay || new Date()))
